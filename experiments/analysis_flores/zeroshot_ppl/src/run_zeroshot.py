...
Run from repo root (with env activated):
    python experiments/analysis_flores/zeroshot_ppl/src/run_zeroshot.py

Outputs (in experiments/analysis_flores/zeroshot_ppl/results/):
...
def main():
    ...
    out_csv = RESULTS_DIR / "ppl_matrix.csv"
    df.to_csv(out_csv)
    ...
    unk_csv = RESULTS_DIR / "unk_rate_matrix.csv"
    ...
    nn_csv = RESULTS_DIR / "nearest_lm_per_variety.csv"
