...
```bash
# solo FastText
python analysis_flores/subword_fasttext/src/run_approach.py --pipeline fasttext

# solo BPE + TF-IDF
python analysis_flores/subword_fasttext/src/run_approach.py --pipeline bpe

# sottocampionamento per sensitivity
python analysis_flores/subword_fasttext/src/run_approach.py --sample-size 1000
```
