...
4) Same variety set + same labelling as the other methods,
...
# ---------- Paths ----------
# config.py lives in <repo>/analysis/<method>/<dataset>/src/, so REPO_ROOT
# is 5 levels up.
...
# ---------- Varieties (aligned with the other methods) ----------
VARIETIES = [
