...
def build_word_vectorizer() -> TfidfVectorizer:
    ...
    return TfidfVectorizer(
        ...
        lowercase=False,
        # IMPORTANT: no stop_words. sklearn's built-in list would only
        # apply to English and bias the comparison; we let IDF handle
...
if __name__ == "__main__":
    ...
    print("Loading...")
    data, stats = load_all_varieties(verbose=False)
