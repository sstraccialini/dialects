"""
End-to-end orchestrator for the TF-IDF baseline on the Wikipedia corpus.

Launch (from repo root, with venv active):
    python analysis/tfidf/wiki/src/run_baseline.py
"""
...
def main():
    parser = argparse.ArgumentParser(description="TF-IDF baseline orchestrator (Wiki)")
