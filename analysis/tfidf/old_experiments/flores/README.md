...
```bash
pip install -r analysis/tfidf/flores/requirements.txt
...
python analysis/tfidf/flores/src/run_baseline.py --pipeline char

# sottocampionamento per sensitivity
python analysis/tfidf/flores/src/run_baseline.py --sample-size 1000

# seed diverso
python analysis/tfidf/flores/src/run_baseline.py --random-state 7
```
