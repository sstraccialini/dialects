"""
Unified data loader for Word2Vec experiments — three corpora.

Identical contract to analysis/tfidf/core/data_loader.py:
  load_wiki_for_training, load_flores_parallel, load_oldi_parallel
each returning (dict {code: list[str]}, stats DataFrame).
"""
