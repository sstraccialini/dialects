...
```bash
pip install -r analysis/word2vec/flores/requirements.txt
...
python analysis/word2vec/flores/src/run_word2vec.py --sample-size 1000

# seed diverso
python analysis/word2vec/flores/src/run_word2vec.py --random-state 7
```
