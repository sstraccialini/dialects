"""
Word2Vec — train Wiki+OLDI dialect, evaluate on FLORES (NATIVE).

Cell 6 of the FINAL 12-cell experimental matrix.

Launch:
    python analysis/word2vec/experiments/word2vec_wikiOLDI_native/run.py
"""
...
METHOD = "word2vec"
EXPERIMENT = "word2vec_wikiOLDI_native"
TEXT_VARIANT = "native"
...
def main():
    parser = argparse.ArgumentParser(description="Word2Vec wikiOLDI → FLORES (native)")
