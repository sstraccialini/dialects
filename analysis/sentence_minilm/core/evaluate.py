...
def variety_eval(X, codes, out_dir: Union[str, Path], *, method_label: str = "Sentence-MiniLM"):
    ...
    return run_evaluation(
        ...
        # standard for all transformer-derived embeddings.
        isotropy=True,
        isotropy_top_k_pc=1,
    )
...
def parallel_eval(sentence_vectors: Dict[str, np.ndarray], out_dir: Union[str, Path],
                  *, method_label: str = "Sentence-MiniLM"):
