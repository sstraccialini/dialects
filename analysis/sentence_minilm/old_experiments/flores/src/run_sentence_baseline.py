"""
Sentence-embedding baseline on FLORES+ (multilingual MiniLM).

Pipeline:
    1. load per-variety .txt files from Dataset/flores/flores_plus/
...
Method outputs (vectors, run stats) live under method_outputs/sentence/.
Evaluation artefacts live under evaluation_results/sentence/.
"""
...
from config import (
    ...
    SAMPLE_SIZE, SENTENCE_MODEL, SENTENCE_BATCH_SIZE, VARIETY_AGGREGATION,
