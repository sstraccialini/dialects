...
1. Load 2009 parallel sentences per variety (997 dev + 1012 devtest)
   from `Dataset/flores/flores_plus/<slug>.txt`.
...
```
analysis/sentence_baseline/flores/
├── README.md
├── requirements.txt
├── results/
│   ├── sentence/
...
```bash
cd analysis/sentence_baseline/flores/src
python run_sentence_baseline.py
```

Outputs land in `analysis/sentence_baseline/flores/results/sentence/`
