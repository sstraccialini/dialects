...
Coordinates are taken from Glottolog 5.x languoid records.  For varieties
with broad geographic spread (e.g. Lombard) we use the Glottolog languoid
centroid, which is approximate.  Update this file when adding new varieties.
"""
