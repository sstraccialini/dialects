...
Run:
    python -m edoardo.exp2_native_text_original_dialects.lex_matrix.fetch_swadesh \
        --out edoardo/exp2_native_text_original_dialects/lex_matrix/wordlist_swadesh207.csv
"""
